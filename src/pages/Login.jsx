...
const Login = () => {
    ...
    return (
        <div className="min-h-screen fixed top-0 left-0 right-0 bg-gradient-to-br  flex items-center justify-center p-4 sm:p-6 md:p-8 overflow-hidden">
            ...
            >
                ...
                >
                    ...
                    <Link to="/signup" className="text-indigo-400 hover:text-indigo-300 underline transition-colors">Sign Up</Link>
                </motion.div>
